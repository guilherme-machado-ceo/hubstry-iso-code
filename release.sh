...
# Script para criar uma build de release do isocode-cli.
...
cargo build --release --bin isocode-cli

# 4. Exibir mensagem de sucesso
echo ""
echo "✅ Build de release concluído com sucesso!"
echo "O binário otimizado está localizado em: target/release/isocode-cli"
